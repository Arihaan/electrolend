...
import {IInitializableELToken} from './IInitializableELToken.sol';
import {IElectroIncentivesController} from './IElectroIncentivesController.sol';

interface IELToken is IERC20, IScaledBalanceToken, IInitializableELToken {
  /**
  ...
  /**
   * @dev Emitted after elTokens are burned
   * @param from The owner of the elTokens, getting them burned
   ...
   **/
  function getIncentivesController() external view returns (IElectroIncentivesController);
